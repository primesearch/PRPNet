...
void  DMDivisorServerHelper::ExpireTests(bool canExpire, int32_t delayCount, delay_t* delays)
{
   ...
   const char* selectSQL = "select DMDRange.n, DMDRange.kMin, DMDRange.kMax, " \
      "       DMDRangeTest.TestID, " \
      "       DMDRangeTest.UserID, DMDRangeTest.EmailID, " \
      "       DMDRangeTest.MachineID, " \
      "       DMDRangeTest.InstanceID " \
      "  from DMDRange, DMDRangeTest " \
      " where DMDRange.n = DMDRangeTest.n " \
      "   and DMDRange.kMin = DMDRangeTest.kMin " \
      "   and DMDRange.kMax = DMDRangeTest.kMax " \
