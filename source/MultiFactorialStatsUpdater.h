#ifndef _MultiFactorialStatsUpdater_

#define _MultiFactorialStatsUpdater_

#include "PrimeStatsUpdater.h"

class MultiFactorialStatsUpdater : public PrimeStatsUpdater
{
private:
...
#endif // #ifndef _MultiFactorialStatsUpdater_
