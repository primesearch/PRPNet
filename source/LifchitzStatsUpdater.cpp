...
bool  LifchitzStatsUpdater::RollupGroupStats(bool deleteInsert)
{
   ...
   const char    *selectSQL = "select b, c from CandidateGroupStats order by b";
...
bool  LifchitzStatsUpdater::UpdateGroupStats(string candidateName)
{
   SQLStatement  *sqlStatement;
   int32_t        theB, theC;
   bool           success;
...
bool  LifchitzStatsUpdater::UpdateGroupStats(int64_t theK, int32_t theB, int32_t theN, int64_t theC)
{
   SQLStatement *sqlStatement;
   bool          success;
...
bool   LifchitzStatsUpdater::InsertCandidate(string candidateName, int64_t theK, int32_t theB, int32_t theN,
