...
GFNDivisorWorkSender::GFNDivisorWorkSender(DBInterface* dbInterface, Socket* theSocket, globals_t* globals,
...
void  GFNDivisorWorkSender::ProcessMessage(string theMessage)
{
...
int32_t  GFNDivisorWorkSender::SelectWork(int32_t sendWorkUnits)
{
...
bool     GFNDivisorWorkSender::ReserveRange(int32_t n, int64_t kMin, int64_t kMax)
{
...
bool     GFNDivisorWorkSender::SendWork(int32_t n, int64_t kMin, int64_t kMax)
{
   int64_t  lastUpdateTime;
   bool     sent;
   SQLStatement* sqlStatement;
   SharedMemoryItem* threadWaiter;
   const char* insertSQL = "insert into GFNDRangeTest " \
