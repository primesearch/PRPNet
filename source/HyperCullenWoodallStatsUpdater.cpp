...
bool  HyperCullenWoodallStatsUpdater::RollupGroupStats(bool deleteInsert)
{
...
bool  HyperCullenWoodallStatsUpdater::UpdateGroupStats(string candidateName)
{
   SQLStatement  *sqlStatement;
   int32_t        theB, theC;
   bool           success;
...
bool  HyperCullenWoodallStatsUpdater::UpdateGroupStats(int64_t theK, int32_t theB, int32_t theN, int64_t theC)
{
   SQLStatement *sqlStatement;
   bool          success;
...
bool   HyperCullenWoodallStatsUpdater::InsertCandidate(string candidateName, int64_t theK, int32_t theB, int32_t theN,
