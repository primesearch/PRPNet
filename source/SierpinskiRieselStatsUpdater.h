...
{
public:
   bool  SetSierspinkiRieselPrimeN(int64_t theK, int32_t theB, int64_t theC, int32_t theD, int32_t theN);

private:
   bool  SetHasSierspinkiRieselPrime(int64_t theK, int32_t theB, int64_t theC, int32_t theD, bool &foundOne);
