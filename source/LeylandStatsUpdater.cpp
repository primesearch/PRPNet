...
bool  LeylandStatsUpdater::RollupGroupStats(bool deleteInsert)
{
...
bool  LeylandStatsUpdater::UpdateGroupStats(string candidateName)
{
   SQLStatement  *sqlStatement;
   int32_t        theB, theC;
   bool           success;
...
bool  LeylandStatsUpdater::UpdateGroupStats(int64_t theK, int32_t theB, int32_t theN, int64_t theC)
{
   SQLStatement *sqlStatement;
   bool          success;
...
bool   LeylandStatsUpdater::InsertCandidate(string candidateName, int64_t theK, int32_t theB, int32_t theN,
