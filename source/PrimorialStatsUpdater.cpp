...
bool  PrimorialStatsUpdater::RollupGroupStats(bool deleteInsert)
{
...
bool  PrimorialStatsUpdater::UpdateGroupStats(string candidateName)
{
   SQLStatement  *sqlStatement;
   int32_t        theC;
   bool           success;
...
bool  PrimorialStatsUpdater::UpdateGroupStats(int64_t theK, int32_t theB, int32_t theN, int32_t theC)
{
   SQLStatement *sqlStatement;
   bool          success;
...
bool   PrimorialStatsUpdater::InsertCandidate(string candidateName, int64_t theK, int32_t theB, int32_t theN,
